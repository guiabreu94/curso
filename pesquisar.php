...
<html>
    ...
    <body>
        <form action="">
            ...
            <div class="btn btn-default">
                <h1>Inserção</h1>
                <a class="btn btn-info" href="insercao_perguntas.php">Inserir perguntas</a>
                <a class="btn btn-info" href="insercao_respostas.php">Inserir respostas</a>
            </div>
            <script>
        ...
        <div class="btn btn-default">
            ...
            <br><br>
            <footer></footer>
            <br><h1>Clique em qualquer uma das caixas para edita-las</h1>
        <div id="conteudo">
...
<input type="button" class="btn btn-info" id="boto" value="Quantidade" onclick='+"'"+'escolha_tipo('+id+')'+"'"+' >';
                      ...
                      //  console.log("esse é o id do butao");
                      //  console.log(document.getElementById(id+"cp"));
                        texto = '<textarea name="conteudo" rows="4" cols="50" id="p'+id+'_Conteudop"> </textarea> <input type="button" class="btn btn-info" value="mudar" onclick='+"'"+'enviar('+id+',"p","Conteudop")'+"'"+' > ';
                        document.getElementById(id+"cp").innerHTML=texto;
...
<input type="button" class="btn btn-info" value="mudar" onclick='+"'"+'enviar('+id+',"r","status")'+"'"+' >';
                      ...
                      //  console.log(document.getElementById(id+"cr"));
                        texto = '<textarea name="conteudo" rows="4" cols="50" id="p'+id+'_Conteudor"> </textarea> <input type="button" class="btn btn-info" value="mudar" onclick='+"'"+'enviar('+id+',"p","Conteudor")'+"'"+' > ';
                        document.getElementById(id+"cr").innerHTML=texto;
        ...
        funcao="editar_perguntas";
          ...
          //  console.log("Antes do if: "+vslot);
            ...
            vslot="cp";
         document.getElementById(vid+vslot).innerHTML= '<input type="button" class="btn btn-default"  value="'+mudanca+'" onclick="editar_perguntas('+vid+',4)">' ;

        }else if(vslot==="Conteudor"){
        }
        else{
         vslot="cr";
         document.getElementById(vid+vslot).innerHTML= '<input type="button" class="btn btn-default"  value="'+mudanca+'" onclick="editar_perguntas('+vid+',5)">' ;
        }
