...
<input type="button" class="btn btn-info" value="mudar" onclick='+"'"+'enviar('+id+',"p","Status")'+"'"+' >';
                      ...
                      //  console.log(document.getElementById(id+"t"));
                        ...
                        texto = '<select id="quantidade"  name="escolhido" >\n\
                                                  <option value="1">1 Tipo</option>\n\
                                                  <option value="2">2 Tipos</option>\n\
                                                  <option value="3">3 Tipos</option>\n\
                                                  <option value="4">4 Tipos</option>\n\
                                                  </select>\n\
<input type="button" class="btn btn-info" value="Quantidade" onclick="escolha_tipo('+id+')">';
...
<input type="button" class="btn btn-info" value="mudar" onclick='+"'"+'enviar('+id+',"p","Tipo")'+"'"+' >';
     ...
     <input type="button" class="btn btn-success" value="confirmar" onclick="gerar_butao("'+document.getElementById("Tipo1").value+','+document.getElementbyId("Tipo2")+'",'+num_tipo+','+id+')"  ';
                   document.getElementById(id+"t").innerHTML=texto;
...
<input type="button" class="btn btn-success" value="confirmar" onclick="gerar_butao("'+document.getElementById("Tipo1").value+','+document.getElementbyId("Tipo2")+','+document.getElementById("Tipo3")+'",'+num_tipo+','+id+')"';
                    document.getElementById(id+"t").innerHTML=texto;
       }else if(num_tipo===4){
...
\n\<input type="button" class="btn btn-success" value="confirmar" onclick="gerar_butao("'+document.getElementById("Tipo1").value+','+document.getElementbyId("Tipo2")+','+document.getElementById("Tipo3")+','+document.getElementById("Tipo4")+'",'+num_tipo+','+id+')"';
                                                   document.getElementById(id+"t").innerHTML=texto;
    ...
    function gerar_butao(valor,num,id){
    var texto;
...
<input type="button" class="btn btn-danger" value="voltar onclick="escolha_tipo('+id+',"t")"\n\
     ';
  };
