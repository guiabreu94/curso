...
$(document).ready(function(){
                     ...
                     ?> <?php
                      while($pergunta= mysqli_fetch_array($perguntas_cont)){//Enquanto houverem perguntas a serem trazidas do banco tal comando continuará rodando
                       ...
                       echo  "<LI>";  echo '<a class="btn btn-default">'.$pergunta["conteudo"].'</a>'; //Printa só o conteúdo da pergunta na tela do usuário
                        //numero da questao
    echo "&ensp;";
 echo '<input type="button" id="respostas'.$cont.'" class="btn btn-info" value="responder" onclick=aparecer'.$cont.'(),post'.$cont.'(),atualizar()> ' ; echo "<br><br>";
 ...
 //echo '<input type="button" value="limpar" onclick=limpar'.$cont.'(),atualizar()> '
          ...
          var div = document.getElementById("limpar<?php echo $cont;  ?>");//nome do id do local onde será posto o botão limpar
                ...
                div.innerHTML = '<input type="button" value="limpar" class="btn btn-danger" onclick=limpar'+<?php echo $cont;  ?>+'(),atualizar()>';}}//printa o botao limpar em limpar especifico
