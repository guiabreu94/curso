...
Anotações:
 * 1-Necessário saber o nome do aluno para poder redirecionar a nota dele no termino do questionario
 * 2-Necessário saber qual o curso para podeer identificar qual questionario será feito pelo aluno
 * 3-Necessário o nome do aluno para no final exibir para eles a sua pontuação
 * 
 ...
 $PostNomePagina = $_POST["Canvas pagina"];
